...
const Services = () => {
  return (
    <div>
        <div className="bg-[#198cf6] md:w-[205px] w-[190px] h-[68px] text-[#fff] text-[20px] md:text-[25px] font-inter font-semibold flex justify-center items-center">Services</div>
